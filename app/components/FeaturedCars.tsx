        ...
        <AnimatedSection className="flex flex-col md:flex-row md:items-end justify-between mb-12">
          <div>
            ...
            <h2 className="heading-lg text-navy-900">
              Autos seleccionados
              <br />
              <span className="text-navy-500">para ti</span>
            </h2>
          </div>
          <Link
            to="/inventario"
            className="inline-flex items-center gap-2 text-navy-900 font-semibold hover:text-navy-700 transition-colors group mt-4 md:mt-0"
          >
