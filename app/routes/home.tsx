...
export default function Home({ loaderData }: Route.ComponentProps) {
  ...
  return (
    <Layout>
      ...
      {/* Stats Section */}
      <section className="py-16 bg-white dark:bg-navy-950 relative -mt-1">
            ...
            {stats.map((stat, index) => (
              ...
              >
                <motion.div
                  ...
                  className="p-6"
                >
                  <stat.icon className="w-8 h-8 text-navy-500 dark:text-navy-400 mx-auto mb-3" />
                  <p className="text-4xl font-bold text-navy-900 dark:text-white mb-1">
                    {stat.value}
                  </p>
                  <p className="text-navy-500 dark:text-navy-400 text-sm">{stat.label}</p>
                </motion.div>
              </AnimatedSection>
            ))}
          </div>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              ...
              <h2 className="heading-lg text-navy-900 dark:text-white mb-6">
                La confianza que
                <br />
                <span className="text-navy-500 dark:text-navy-400">mereces</span>
              </h2>
              ...
              <ul className="space-y-4">
                {[
                  ...
                  >
                    <div className="w-6 h-6 rounded-full bg-navy-100 dark:bg-navy-800 flex items-center justify-center flex-shrink-0">
                      <svg
                        className="w-4 h-4 text-navy-700 dark:text-navy-300"
                        fill="none"
                        viewBox="0 0 24 24"
                        stroke="currentColor"
                      >
            ...
            <AnimatedSection direction="right">
              <div className="relative">
                <div className="absolute -inset-4 bg-navy-100 dark:bg-navy-800 rounded-3xl -rotate-3" />
                <img
                ...
                {/* Floating badge */}
                <motion.div
                  className="absolute -bottom-6 -left-6 bg-white dark:bg-navy-900 rounded-2xl p-6 shadow-xl dark:shadow-navy-950/50"
                  animate={{ y: [0, -10, 0] }}
                  transition={{ duration: 4, repeat: Infinity }}
                >
                  <p className="text-sm text-navy-500 dark:text-navy-400 mb-1">Miembro ANCA</p>
                  <p className="text-3xl font-bold text-navy-900 dark:text-white">#11</p>
                </motion.div>
              </div>
            </AnimatedSection>
          </div>
